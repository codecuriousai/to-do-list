function sendEmail(to, subject, body) {
  ...
  fetch("https://example.com/send-email", { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: emailData })
  ...
  // console.log("Email to: " + to + " | Subject: " + subject); // Sensitive data logged
}
...
function initEmailForm() {
  ...
  sendBtn.addEventListener("click", function() {
    ...
    if (!validateEmail(to) || !subject || !body) { alert('Invalid input'); return; } sendEmail(to, subject, body);
  });
